    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-6">This listing may have been removed or the link is incorrect.</p>
          <Link
            href="/search"
                ...
                {images.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute left-3 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white rounded-full w-10 h-10 flex items-center justify-center shadow-md"
                    >
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white rounded-full w-10 h-10 flex items-center justify-center shadow-md"
                    >
                  ...
                  <div className="absolute bottom-3 left-1/2 -translate-x-1/2 flex gap-1.5">
                    {images.map((_, i) => (
                      <button
                        ...
                        className={`w-2.5 h-2.5 rounded-full transition-colors ${i === activeImg ? 'bg-white' : 'bg-white/50'}`}
                      />
                    ))}
                  </div>
                )}
